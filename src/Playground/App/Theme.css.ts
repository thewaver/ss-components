...
const DEFAULT_THEME_VALUES = {
    ...
    color: {
        primary: {
            ...
            main: "hsl(165, 75%, 50%)",
            light: "hsl(165, 50%, 60%)",
            contrast: "hsl(165, 25%, 10%)",
        },
        secondary: {
            dark: "hsl(255, 50%, 40%)",
            main: "hsl(255, 75%, 50%)",
            light: "hsl(255, 50%, 60%)",
            contrast: "hsl(255, 25%, 90%)",
        },
        info: {
            dark: "hsl(225, 50%, 40%)",
            main: "hsl(225, 75%, 50%)",
            light: "hsl(225, 50%, 60%)",
            contrast: "hsl(225, 25%, 10%)",
        },
        success: {
            dark: "hsl(90, 50%, 40%)",
            main: "hsl(90, 75%, 50%)",
            light: "hsl(90, 50%, 60%)",
            contrast: "hsl(90, 25%, 10%)",
        },
        alert: {
            dark: "hsl(45, 50%, 40%)",
            main: "hsl(45, 75%, 50%)",
            light: "hsl(45, 50%, 60%)",
            contrast: "hsl(45, 25%, 10%)",
        },
        error: {
            dark: "hsl(0, 50%, 40%)",
            main: "hsl(0, 75%, 50%)",
            light: "hsl(0, 50%, 60%)",
            contrast: "hsl(0, 25%, 10%)",
        },
        background: {
            dark: "hsl(30, 10%, 10%)",
            light: "hsl(30, 10%, 20%)",
